...
ohne Zustimmung eines Admins beigetreten werden kann. Somit besteht auch eine Abhängigkeit
zum Subsystem der Rollenverteilung.
...
* mops.gruppen1.domain.events/MembershipRequestEvent
...
* mops.gruppen1.domain/MembershipType.java (Enum)
* mops.gruppen1.domain/Membership.java
...
* mops.gruppen1.domain.events/MembershipUpdateEvent.java
...
* mops.gruppen1.applicationService/CheckService.java
