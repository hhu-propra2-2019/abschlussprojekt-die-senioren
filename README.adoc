...
*Aktuell* gibt es kein integriertes System für:
...
Als *primäre* Referenz kann das https://github.com/hhu-propra2/abschlussprojekt-die-senioren/wiki/[Wiki] herangezogen werden. Im Wiki befinden sich verschiedene Dokumentationen zu einzelnen Aspekten des Projekts.